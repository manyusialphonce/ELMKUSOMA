...
```
      ...
      <p className="mt-3 max-w-2xl text-gray-600">
        Explore colleges and professional institutions and
        discover their programs and available courses.
      </p>
    </div>
  </section>
    ...
    {loading ? (
      ...
      <div className="mt-8 rounded-2xl border border-gray-200 bg-white p-10 text-center">
        ...
        <p className="mt-2 text-gray-600">
          No colleges match your current search and filters.
        </p>
      </div>
    ) : (
