...
/* =========================================================
   SAMPLE SCHOOLS - FRONTEND FALLBACK DATA
========================================================= */
...
const sampleSchools = [
  ...
  },
  {
    ...
    isVerified: true,
    description:
      'Mbezi Louis Primary School is dedicated to providing accessible and quality education.',
  },
  {
    id: 5,
    ...
    isVerified: true,
    description:
      'Mlimani Primary School promotes quality learning, creativity and discipline.',
  },
...
export default function SchoolsList() {
  ...
  const regions = useMemo(() => {
    const regionNames = schools
      .map((school) => {
        if (typeof school.region === 'string') {
  ...
  const getCategoryCount = (category) => {
    return schools.filter((school) => {
      if (category.id === 'elmkusoma-private') {
        return (
          school.isElmkusoma === true ||
          school.isElmkusomaPrivate === true ||
          String(school.academicLevel || '').toLowerCase() ===
            'elmkusoma'
        );
      }
    ...
    return schools.filter((school) => {
      ...
      const region =
        typeof school.region === 'string'
          ...
          : school.region?.name?.toLowerCase() || '';

      const district =
        typeof school.district === 'string'
          ? school.district.toLowerCase()
          : school.district?.name?.toLowerCase() || '';
      ...
      let matchesSecondaryLevel = true;

      if (
        categoryFromUrl === 'secondary' &&
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-base leading-7 text-slate-300 sm:text-lg">
              Choose an institution category below to explore
              schools, colleges and universities available
              through ELMKUSOMA.
            </p>
          </div>
        </div>
        ...
        <section>
          <div className="mb-8">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
              Select the type of institution you want to explore.
            </p>
          </div>
            ...
            {categories.map((category) => {
              ...
              return (
                <button
                  ...
                  className={`group relative overflow-hidden rounded-3xl border p-6 text-left transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${
                    isActive
