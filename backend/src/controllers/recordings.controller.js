...
// GET /api/v1/recordings/mine  (Teacher — own uploads, including drafts)
const myRecordings = asyncHandler(async (req, res) => {
  const recordings = await prisma.recording.findMany({
...
module.exports = { listRecordings, getRecording, createRecording, publishRecording, myRecordings };
